/*
Universal Project Interface v0.3.07
...
Github CountZero1066
   ...
   Version Detail:
            -Refined GUI interface within the Wi-Fi scan module   
...
int menu_index = 0, prior_menu_index = 0, check_index_change = 0, current_key_selection = 0, prior_key_selection = 0, smart_12v_index = 0, prior_smart_12v_index = 0, scan_WiFi_index = 0, prior_scan_WiFi_index = 0, buff_index;
bool main_menu_active, item_select, keyboard_active, smart_12V_UI_active,scan_wifi_active, capslock_active, smart_12V_MAC_request, scroll_data;
//-------------------------------------------------------------------------------------------
//Setup
//-------------------------------------------------------------------------------------------
void setup() 
                      ...
                      switch(bits){
                              ...
                              //up key
                                     if(main_menu_active ==true){
                                      ...
                                      Scan_Wifi_Index_Manager(1);
                                    }
                                    else if(main_menu_active ==false && scroll_data == true){
                                      Scroll_data_Index_Manger(1);
                                    }
                              break;
                              ...
                              //down key
                                     if(main_menu_active ==true){
                                      ...
                                      Scan_Wifi_Index_Manager(3);
                                    }
                                    else if(main_menu_active ==false && scroll_data == true){
                                      Scroll_data_Index_Manger(3);
                                    }
                              break;
                             ...
                             //center key
                                    if(main_menu_active ==true){
                                     ...
                                     Scan_Wifi_Index_Manager(5);
                                    }
                                    else if(main_menu_active ==false && scroll_data == true){
                                      Scroll_data_Index_Manger(5);
                                    }
                             break;
                    } //end of switch  
                    } //end of If
...
//-------------------------------------------------------------------------------------------
//Scan WiFi Idex Manager
//decision logic to determine new index location
//-------------------------------------------------------------------------------------------
void Scan_Wifi_Index_Manager(int button){
  switch(button){
    case 1: //up
          if (scan_WiFi_index == 0){
            prior_scan_WiFi_index = scan_WiFi_index;
            scan_WiFi_index =2;
          }
          else{
            prior_scan_WiFi_index = scan_WiFi_index;
    ...
    case 5: //enter
        if (scan_WiFi_index == 0 ){
          ...
          List_nearby_APs();
          buff_index = text_buffer[0].toInt();
          scroll_data = true;
        }
        else if (scan_WiFi_index == 1 ){
          scan_wifi_active = false;
          num_mac_add = 0;
          start_sniffing();
          buff_index = text_buffer[0].toInt();
  ...
  Scan_Wifi_Interface_Logic(scan_WiFi_index);
}
//-------------------------------------------------------------------------------------------
//Scroll Data Idex Manager
//decision logic to determine new index location
//-------------------------------------------------------------------------------------------
void  Scroll_data_Index_Manger(int button){
  
  switch(button){
    
    case 1:
        buff_index = scroll_buffer(button, buff_index);
    break;
    case 3:
        buff_index = scroll_buffer(button, buff_index);
    break;
...
void Draw_scan_wifi_UI(){
  ...
  display1.drawRect(2,56,62,6, WHITE);
  display1.setCursor(4,8 );
  display1.println("SCNR ");
  display1.setCursor(4,26 );
  display1.println("SNFR ");
  display1.display();
}
...
//describes UI behaviour upon changes to index value
//-------------------------------------------------------------------------------------------
void Scan_Wifi_Interface_Logic(int index){
    if (scan_wifi_active == true){
      // if (index >= 0 || index <=2){
      display1.fillRect(2,scan_Wifi_cords[index],62,16, WHITE);
      display1.setTextColor(BLACK);
      display1.setCursor(4,scan_Wifi_cords[index + 3] );
      display1.println(Wifi_menu_txt[index]);
 // }
 
  //if (prior_scan_WiFi_index >= 0 || prior_scan_WiFi_index <=2){
      display1.fillRect(2,scan_Wifi_cords[prior_scan_WiFi_index],62,16, BLACK);
      display1.drawRect(2,scan_Wifi_cords[prior_scan_WiFi_index],62,16, WHITE);
      display1.setTextColor(WHITE);
      display1.setCursor(4,scan_Wifi_cords[prior_scan_WiFi_index + 3] );
      display1.println(Wifi_menu_txt[prior_scan_WiFi_index]);
  //}
